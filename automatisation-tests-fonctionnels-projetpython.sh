...
echo '------------------------------------------------------------------------'
echo 'TESTS RECUPERATION DE TOUS LES IDENTIFIANTS OK'
echo '------------------------------------------------------------------------'
curl -u "benoitlarroque:mssio" "http://127.0.0.1:5000/getall"
echo '------------------------------------------------------------------------'
echo 'TESTS RECUPERATION DE TOUS LES IDENTIFIANTS KO'
echo '------------------------------------------------------------------------'
curl -u "utilisateur:mdp" "http://127.0.0.1:5000/getall"
echo '------------------------------------------------------------------------'
echo 'FIN TESTS'
echo '------------------------------------------------------------------------'
